<?php
/*
Plugin Name: Image Slider Widget
			...
			timeout = setTimeout(function(){
				if(iframejq != undefined){
					...
					iframejq("#go_button").each(function(i, e){
						iframejq(e).attr("value",  "'.__('Send Image to Slider Widget', $this->textdomain).'");
					});
					iframejq(".savesend > input[type=submit]").each(function(){
						jQuery(this).attr("value", "'.__('Send Image to Slider Widget', $this->textdomain).'");
					});
		...
		if ($is_there_a_problem === false) {
			...
			if (array_search($slider_options['theme'],$this->default_themes) === false){
				...
				if (is_dir(WP_PLUGIN_DIR.'/'.$slider_options['theme']))
					wp_register_style('weptile-image-slider-widget-nivo-slider-theme-'.$slider_options['theme'], plugins_url() . '/'.$slider_options['theme'].'/'.$slider_options['theme'].'.css');
				else
					$slider_options['theme'] = 'default';
			}
...
function weptile_image_slider_widget_admin_actions($hook) {
	...
	wp_register_script('weptile-image-slider-widget-admin', path_join(plugins_url(), basename(dirname(__FILE__)) . '/js/weptile-image-slider-widget-admin.js'));
	wp_enqueue_script('weptile-image-slider-widget-admin');

	// Styles
	wp_register_style('weptile-image-slider-widget', path_join(plugins_url(), basename(dirname(__FILE__)) . '/css/weptile-image-slider-widget-admin.css'));
...
function weptile_image_slider_widget_actions() {
	...
	wp_register_script('weptile-image-slider-widget', path_join(plugins_url(), basename(dirname(__FILE__)) . '/js/weptile-image-slider-widget.js'));
	wp_enqueue_script('weptile-image-slider-widget');
	//for nivo slider
	wp_register_script('weptile-image-slider-widget-nivo-slider', path_join(plugins_url(), basename(dirname(__FILE__)) . '/nivo-slider/jquery.nivo.slider.pack.js'));
	wp_enqueue_script('weptile-image-slider-widget-nivo-slider');


	// Styles
	wp_register_style('weptile-image-slider-widget', path_join(plugins_url(), basename(dirname(__FILE__)) . '/css/weptile-image-slider-widget.css'));
	wp_enqueue_style('weptile-image-slider-widget');
	//for nivo slider
	wp_register_style('weptile-image-slider-widget-nivo-slider', path_join(plugins_url(), basename(dirname(__FILE__)) . '/nivo-slider/nivo-slider.css'));
	wp_enqueue_style('weptile-image-slider-widget-nivo-slider');
	//register nivo slider themes for widget calls
	wp_register_style('weptile-image-slider-widget-nivo-slider-theme-default', path_join(plugins_url(), basename(dirname(__FILE__)) . '/nivo-slider/themes/default/default.css'));
	wp_register_style('weptile-image-slider-widget-nivo-slider-theme-bar', path_join(plugins_url(), basename(dirname(__FILE__)) . '/nivo-slider/themes/bar/bar.css'));
	wp_register_style('weptile-image-slider-widget-nivo-slider-theme-dark', path_join(plugins_url(), basename(dirname(__FILE__)) . '/nivo-slider/themes/dark/dark.css'));
	wp_register_style('weptile-image-slider-widget-nivo-slider-theme-light', path_join(plugins_url(), basename(dirname(__FILE__)) . '/nivo-slider/themes/light/light.css'));
