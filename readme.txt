...
3. Add your "image slider widget" to any sidebar from the 'Widgets' screen.
...
1. Image Slider Widget Settings Panel

2. Image Slider Widget Settings Panel - Slider Effects
